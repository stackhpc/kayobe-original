...
.. warning::
    ...
    Support for infrastructure is considered experimental: its
...
.. note::
    ...
    can be followed. Please see :ref:`infra-vms`.
...
A no-op command is provided to allow hooks to perform additional
configuration.
...
.. seealso::
    ...
    Information on configuration of hooks is available :ref:`here
    <custom-playbooks-hooks>`.
